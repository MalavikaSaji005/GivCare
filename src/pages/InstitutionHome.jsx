...
export default function InstitutionHome() {
  ...
  const isConfirmationsView = query === "?view=confirmations";
  ...
  return (
    <DashboardLayout>
      <div className="bg-[#F8FAF9] min-h-screen p-2 space-y-14">
          ...
          <div className="space-y-6 mt-4">
            ...
            <div>
              ...
              <p className="text-gray-500 mt-1">
                Track and verify donations before they are processed.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-10 shadow-sm text-center">
              ...
              <div className="flex flex-col items-center justify-center">
                ...
                <p className="text-sm text-gray-500 mt-2">
                  When donors submit a donation, it will appear here.
                </p>
            ...
            <div className="bg-[#EEF2F1] rounded-3xl px-10 py-12 flex justify-between items-center">
              <div className="max-w-xl">
                ...
                <button
                  ...
                  className="mt-6 bg-primary text-white px-6 py-2 rounded-full shadow-md hover:opacity-90 transition"
                >
                  Manage Needs
                </button>
              </div>
